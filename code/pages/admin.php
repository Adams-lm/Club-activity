  ...
  <div id="wrapper" style="height:100%">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="font-size: 1.8rem;">
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="admin.php" style="font-size: 2.3rem;">社团名称</a>
      </div>

      <!-- Collect the nav links, forms, and other content for toggling -->
      <div class="collapse navbar-collapse navbar-ex1-collapse" id="navbar" style="background-color:#001529">      <!-- 顶部颜色 -->
        <ul class="nav navbar-nav side-nav" style="background-color:#001529"> <!-- 侧边颜色 -->
        ...
        <ul class="nav navbar-nav navbar-right navbar-user">
          <li class="dropdown user-dropdown">
            ...
            <a href="#" class="dropdown-toggle" style="padding: 10px 40px;" data-toggle="dropdown" style="font-size: 1.8rem;">
